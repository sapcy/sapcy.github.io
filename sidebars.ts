      ...
      items: [
        {
          ...
          key: 'k8s-concepts',
          items: [
            'cloud/kubernetes/concept-kubernetes-overview',
            'cloud/kubernetes/concept-pod',
            'cloud/kubernetes/concept-kube-scheduler',
            'cloud/kubernetes/concept-kube-controller-manager',
            'cloud/kubernetes/concept-containerd-cri',
          ],
        },
        {
          type: 'category',
          ...
          key: 'k8s-ops',
          items: [
            'cloud/kubernetes/kyaml-kubernetes-yaml',
            'cloud/kubernetes/k8s-api-tls-external-request',
            'cloud/kubernetes/kubectl-top-vs-free-memory',
            'cloud/kubernetes/k3s-x86-orbstack-apple-silicon',
            'cloud/kubernetes/sealed-secrets-gitops',
          ],
        },
        {
          type: 'category',
          ...
          key: 'k8s-network',
          items: [
            'cloud/kubernetes/network-calico-cni',
            'cloud/kubernetes/network-cilium-cni',
            'cloud/kubernetes/network-cilium-components',
            'cloud/kubernetes/network-cilium-pod-to-pod',
            'cloud/kubernetes/network-coredns-multiple-dns',
            'cloud/kubernetes/network-kernel-tuning',
            'cloud/kubernetes/network-router-vs-gateway',
            {
              type: 'category',
              label: 'Envoy',
