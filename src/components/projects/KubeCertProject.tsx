...
import {
  generateKubeCerts,
  type KubeCertRequest,
  type KubeCertResult,
} from '../../sapcy-shims/web-kube-cert';
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateField('apiServerAddress', e.target.value)
                }
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateField('clusterName', e.target.value)
                  }
                  className="w-full px-3 py-2 rounded material-input text-sm"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateField('serviceCIDR', e.target.value)
                  }
                  className="w-full px-3 py-2 rounded material-input text-sm"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateField('additionalSANs', e.target.value)
                }
                className="w-full px-3 py-2 rounded material-input text-sm"
                placeholder="k8s.example.com, 10.0.0.100"
              />
              <p className="text-xs text-gray-500 mt-1">
                Comma-separated domains or IPs
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateField('caDays', parseInt(e.target.value, 10) || 36500)
                  }
                  className="w-full px-3 py-2 rounded material-input text-sm"
                  min={1}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateField('certDays', parseInt(e.target.value, 10) || 3650)
                  }
                  className="w-full px-3 py-2 rounded material-input text-sm"
                  min={1}
                />
            ...
            <div>
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  onChange={(e) =>
                    updateField('includeEtcd', e.target.checked)
                  }
                  className="w-4 h-4 rounded border-gray-300"
                />
                <span className="text-sm text-gray-700">
                  Include etcd certificates
                </span>
              </label>
              ...
              {request.includeEtcd ? (
                <div className="mt-3">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateField('etcdServers', e.target.value)
                    }
                    className="w-full px-3 py-2 rounded material-input text-sm"
          ...
          {!result && !error ? (
            <div className="text-center py-12 text-gray-500">
              <p className="text-sm mb-4">
                Enter cluster information and generate certificates.
              </p>
...
sudo kubeadm init --skip-phases=certs`}</pre>
              ...
              <p className="text-xs text-gray-500">
                Keep private keys (.key) secure. Never commit to public
                repositories.
              </p>
            </div>
          ) : null}
